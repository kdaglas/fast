...
class Test_For_Empty_Values(unittest.TestCase):
    ...
    def test_input_with_empty_username(self):
        ...
        self.assertEquals(reply["message"], "Your username is missing")
    ...
    def test_input_with_empty_contact(self):
        ...
        reply = json.loads(response.data)
        self.assertEquals(reply["message"], "Your contact is missing")
        self.assertEquals(response.status_code, 400)
    ...
    def test_input_with_empty_password(self):
        ...
        reply = json.loads(response.data)
        self.assertEquals(reply["message"], "Your password is missing")
        self.assertEquals(response.status_code, 400)
